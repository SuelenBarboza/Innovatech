[file name]: ProcessRegisterCoord.php
[file content begin]
<?php
session_start();
...
if (!isset($_SESSION['usuario_tipo']) || !in_array($_SESSION['usuario_tipo'], ['Admin', 'coordinator'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['acao'])) {
        ...
        if ($acao === 'aprovar') {
            ...
            // Coordenador só pode aprovar professores e alunos
            if (!$is_admin && !in_array($tipo_aprovado, ['teacher', 'student'])) {
                $_SESSION['msg'] = "Apenas administradores podem aprovar outros tipos de usuários.";
                header("Location: ProcessRegisterCoord.php");
                exit;
            }
...
// Buscar usuários pendentes que coordenador pode aprovar
if ($is_admin) {
    $sql = "SELECT id, username, email, tipo_solicitado, data_criacao 
            FROM usuarios 
            WHERE status = 'pendente' 
            AND tipo_solicitado IN ('teacher', 'student')
...
<head>
    ...
    <title>Aprovação de Cadastros - Coordenador</title>
    ...
    <style>
        * {
        ...
        .header {
            background: linear-gradient(135deg, #0d7d71 0%, #2ec469 100%);
            color: white;
            padding: 25px 40px;
            display: flex;
    ...
    <div class="container">
        <div class="header">
            <h1>
                ...
                Painel de Aprovação - Coordenador
                <?php if ($is_admin): ?>
                    <span style="font-size: 14px; opacity: 0.9;">(Visualização como Admin)</span>
                <?php endif; ?>
            </h1>
        ...
        <?php if (isset($_SESSION['msg'])): ?>
            <div class="mensagem <?php echo strpos($_SESSION['msg'], 'Erro') !== false ? 'erro' : 'sucesso'; ?>">
        ...
        <div class="permissao-info">
            ...
            <strong>Permissões do Coordenador:</strong> Você pode aprovar ou rejeitar apenas cadastros de Professores e Alunos.
            Cadastros de outros Coordenadores ou Administradores devem ser aprovados por um Administrador.
        </div>
        <?php endif; ?>
        ...
        <div class="main-content">
            <h2 class="section-title">
                ...
                Solicitações Pendentes para Professores e Alunos
                    ...
                    <div class="usuario-card">
                        ...
                        <form method="POST" class="form-aprovacao">
                            ...
                            <select name="tipo_aprovado" class="select-tipo" required>
                                ...
                                <?php 
                                $tipos_permitidos = ['teacher', 'student'];
