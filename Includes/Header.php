    ...
    <nav>
        <ul class="menu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <?php if ($usuario_tipo === 'Admin'): ?>
                            ...
                            <li><a href="../Shared/Logs.php">Gerenciar Logs</a></li>
            ...
            <li class="user-profile">
                <a href="#">
                    <img src="<?= htmlspecialchars($usuario_foto) ?>" class="user-avatar" alt="Foto do usuário">
                    <div class="user-info">
                        <span class="user-name"><?= htmlspecialchars($usuario_nome) ?></span>
                        <span class="user-role"><?= htmlspecialchars($usuario_tipo) ?></span>
                    </div>
                </a>
                <ul class="submenu">
