...
function getStatusDisplay($status) {
    switch ($status) {
        ...
        case 'aguardando':
            return ['text' => '⏳ Aguardando Aluno', 'class' => 'aguardando'];
        case 'concluido':
        case 'Concluído':
...
// STATUS ATUAL
// ==========================
$statusRaw = $relatorio['status'] ?? 'novo';
...
<div class="container">
    ...
    <div class="report-header">
        <div>
            ...
            <p><strong>👨‍🏫 Professor:</strong> <?= htmlspecialchars($relatorio['professor_nome'] ?? 'Não atribuído') ?></p>
    ...
    <div class="historico-respostas">
        ...
        <?php else: ?>
            <?php while ($r = $respostas->fetch_assoc()): ?>
                <?php $classe = ($r['tipo_usuario'] === 'Aluno') ? 'aluno' : 'professor'; ?>
...
<div id="confirmModal" class="modal-overlay">
    <div class="modal-container">
        ...
        <div class="modal-footer">
            <button type="button" class="modal-btn-cancel" id="cancelModalBtn">Cancelar</button>
            <a href="?id=<?= $relatorio_id ?>&concluir=1" class="modal-btn-confirm" id="confirmModalBtn">Sim, Concluir</a>
        </div>
    </div>
</div>
